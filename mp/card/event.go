...
const (
	// 推送到公众号URL上的事件类型
	EventTypeCardPassCheck            mp.EventType = "card_pass_check"              // 卡券通过审核
	EventTypeCardNotPassCheck         mp.EventType = "card_not_pass_check"          // 卡券未通过审核
	EventTypeUserGiftingCard          mp.EventType = "user_gifting_card"            // 转赠事件推送
	EventTypeUserGetCard              mp.EventType = "user_get_card"                // 领取事件推送
	EventTypeUserDelCard              mp.EventType = "user_del_card"                // 删除事件推送
	EventTypeUserConsumeCard          mp.EventType = "user_consume_card"            // 核销事件推送
	EventTypeUserViewCard             mp.EventType = "user_view_card"               // 进入会员卡事件推送
	EventTypeUserEnterSessionFromCard mp.EventType = "user_enter_session_from_card" // 从卡券进入公众号会话事件推送
	EventTypeCardSkuRemind            mp.EventType = "card_sku_remind"              // 库存报警事件

	EventTypeGiftCardPayDone    mp.EventType = "giftcard_pay_done"    // 用户购买礼品卡付款成功
	EventTypeGiftCardUserAccept mp.EventType = "giftcard_user_accept" // 用户领取礼品卡成功
)
...
type CardPassCheckEvent struct {
	...
	EventType mp.EventType `xml:"Event"  json:"Event"`  // 事件类型, card_pass_check
	CardId    string       `xml:"CardId" json:"CardId"` // 卡券ID
}

func GetCardPassCheckEvent(msg *mp.MixedMsg) *CardPassCheckEvent {
...
type CardNotPassCheckEvent struct {
	...
	EventType    mp.EventType `xml:"Event"        json:"Event"`  // 事件类型, card_not_pass_check
	CardId       string       `xml:"CardId"       json:"CardId"` // 卡券ID
	RefuseReason string       `xml:"RefuseReason" json:"RefuseReason"`
}

func GetCardNotPassCheckEvent(msg *mp.MixedMsg) *CardNotPassCheckEvent {
...
type UserGetCardEvent struct {
	...
	EventType           mp.EventType `xml:"Event"               json:"Event"`           // 事件类型, user_get_card
	CardId              string       `xml:"CardId"              json:"CardId"`          // 卡券ID
...
func GetUserGetCardEvent(msg *mp.MixedMsg) *UserGetCardEvent {
...
func GetUserGiftingCardEvent(msg *mp.MixedMsg) *UserGiftingCardEvent {
...
type UserDelCardEvent struct {
	...
	EventType    mp.EventType `xml:"Event"        json:"Event"`        // 事件类型, user_del_card
	CardId       string       `xml:"CardId"       json:"CardId"`       // 卡券ID
	UserCardCode string       `xml:"UserCardCode" json:"UserCardCode"` // 商户自定义code 值. 非自定code 推送为空串
}

func GetUserDelCardEvent(msg *mp.MixedMsg) *UserDelCardEvent {
...
type UserConsumeCardEvent struct {
	...
	EventType     mp.EventType `xml:"Event"         json:"Event"`         // 事件类型, user_consume_card
	CardId        string       `xml:"CardId"        json:"CardId"`        // 卡券ID
	UserCardCode  string       `xml:"UserCardCode"  json:"UserCardCode"`  // 商户自定义code 值. 非自定code 推送为空串
...
func GetUserConsumeCardEvent(msg *mp.MixedMsg) *UserConsumeCardEvent {
...
type UserViewCardEvent struct {
	...
	EventType    mp.EventType `xml:"Event"        json:"Event"`        // 事件类型, user_view_card
	CardId       string       `xml:"CardId"       json:"CardId"`       // 卡券ID
	UserCardCode string       `xml:"UserCardCode" json:"UserCardCode"` // 商户自定义code 值. 非自定code 推送为空串
}

func GetUserViewCardEvent(msg *mp.MixedMsg) *UserViewCardEvent {
...
func GetUserEnterSessionFromCardEvent(msg *mp.MixedMsg) *UserEnterSessionFromCardEvent {
...
type CardSkuRemindEvent struct {
	...
	EventType mp.EventType `xml:"Event"  json:"Event"`  // 事件类型, card_sku_remind
	CardId    string       `xml:"CardId" json:"CardId"` // 卡券ID
	Detail    string       `xml:"Detail" json:"Detail"` // 报警详细信息
}

func GetCardSkuRemindEvent(msg *mp.MixedMsg) *CardSkuRemindEvent {
...
type GiftCardPayDoneEvent struct {
	...
	EventType mp.EventType `xml:"Event"   json:"Event"`   // 事件类型，此处为giftcard_pay_done标识订单完成事件
	PageId    string       `xml:"PageId"  json:"PageId"`  // 货架的id
	OrderId   string       `xml:"OrderId" json:"OrderId"` // 订单号
}

func GetGiftCardPayDoneEvent(msg *mp.MixedMsg) *GiftCardPayDoneEvent {
...
type GiftCardUserAcceptEvent struct {
	...
	EventType mp.EventType `xml:"Event"   json:"Event"`   // 事件类型，此处为giftcard_user_accept标识订单完成事件
	PageId    string       `xml:"PageId"  json:"PageId"`  // 货架的id
	OrderId   string       `xml:"OrderId" json:"OrderId"` // 订单号
}

func GetGiftCardUserAcceptEvent(msg *mp.MixedMsg) *GiftCardUserAcceptEvent {
