...
const (
	...
	EventTypeQualificationVerifyFail    mp.EventType = "qualification_verify_fail"    // 资质认证失败
	EventTypeNamingVerifySuccess        mp.EventType = "naming_verify_success"        // 名称认证成功（即命名成功）
	EventTypeNamingVerifyFail           mp.EventType = "naming_verify_fail"           // 名称认证失败（这时虽然客户端不打勾，但仍有接口权限）
	EventTypeAnnualRenew                mp.EventType = "annual_renew"                 // 年审通知
	EventTypeVerifyExpired              mp.EventType = "verify_expired"               // 认证过期失效通知
)
...
func GetQualificationVerifySuccessEvent(msg *mp.MixedMsg) *QualificationVerifySuccessEvent {
...
func GetQualificationVerifyFailEvent(msg *mp.MixedMsg) *QualificationVerifyFailEvent {
...
func GetNamingVerifySuccessEvent(msg *mp.MixedMsg) *NamingVerifySuccessEvent {
...
func GetNamingVerifyFailEvent(msg *mp.MixedMsg) *NamingVerifyFailEvent {
...
func GetAnnualRenewEvent(msg *mp.MixedMsg) *AnnualRenewEvent {
...
func GetVerifyExpiredEvent(msg *mp.MixedMsg) *VerifyExpiredEvent {
