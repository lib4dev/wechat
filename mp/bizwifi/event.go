...
const (
	// 推送到公众号URL上的事件类型
	EventTypeWifiConnected mp.EventType = "WifiConnected" // Wi-Fi连网成功事件
)
...
type WifiConnectedEvent struct {
	...
	EventType mp.EventType `xml:"Event" json:"Event"` // 事件类型，WifiConnected (Wi-Fi连网成功)
...
func GetWifiConnectedEvent(msg *mp.MixedMsg) *WifiConnectedEvent {
