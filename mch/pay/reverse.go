...
// Reverse 撤销订单.
//  NOTE: 请求需要双向证书.
func Reverse(clt *mch.Context, req map[string]string) (resp map[string]string, err error) {
...
// Reverse2 撤销订单.
//  NOTE: 请求需要双向证书.
func Reverse2(clt *mch.Context, req *ReverseRequest) (resp *ReverseResponse, err error) {
