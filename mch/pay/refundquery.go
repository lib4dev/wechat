...
// RefundQuery 查询退款.
func RefundQuery(clt *mch.Context, req map[string]string) (resp map[string]string, err error) {
...
func RefundQuery2(clt *mch.Context, req *RefundQueryRequest) (resp *RefundQueryResponse, err error) {
